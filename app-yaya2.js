...
function chantierList(){
  ...
  cs.forEach(function(c){
    var f=finances(c.id);
    html+='<tr class="clickable" data-chantier="'+esc(c.id)+'"><td class="strong">'+esc(c.nom)+'</td><td>'+signaturePeriodLabel(c)+'</td><td class="money">'+eur(f.ca)+'</td><td class="money '+(f.margin>=0?"margin-good":"margin-bad")+'">'+eur(f.margin)+'</td></tr>';
  });
  html+="</tbody></table></div></div>";
